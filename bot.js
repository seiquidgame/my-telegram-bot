...
bot.on('message', (msg) => {
    ...
    const responses = [
        ...
        { keywords: ["thank", "thanks"], response: "You are welcome. If you have more questions go DM us on X https://x.com/SeiquidGame or visit our official home website https://seiquid.xyz" },
        { keywords: ["hello"], response: "Hi! How can I be of service?" }
    ];
